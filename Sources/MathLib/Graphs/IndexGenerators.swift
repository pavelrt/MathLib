...
extension GraphIndicesGenerator {
  ...
  public init<G: AbstractFiniteGraph>(graph : G) where
    G.V.Index == VertexGenerator.Index, G.E.Index == EdgeGenerator.Index
  {
...
public struct IntIndexGenerator : IndexGenerator {
  ...
  public mutating func used<S>(usedIndices: S) where
    S: Sequence, IntIndexGenerator.Index == S.Element
  {

...
final class SwiftMathTests: XCTestCase {
    ...
    func testDijkstraTestPath() {
        let (path, start, end) = createPath(length: 1000)
    ...
    func testDijkstraTestCircuit() {
        let circuit = createCircuit(length: 1000)
